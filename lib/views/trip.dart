...
import 'package:advance_budget_request_system/views/buttons.dart';
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: DateFilterDropdown(
                    onDateRangeChanged: (range, selectedValue) {
                      setState(() {
                        // Example: Apply your own filtering logic
                        filteredData = tripData.where((trip) {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildRow(
                ...
                "Department",
                widget.tripData.departmentName),
